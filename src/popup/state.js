...
(function () {
  var _state = {
    mode: 'settings',
    city: { name: '', code: '' },
    selectedCities: typeof DEFAULT_TARGET_CITIES !== 'undefined' ? DEFAULT_TARGET_CITIES.slice() : [],
    resumeImages: [],
    selectedPositions: [],
    customPositions: typeof DEFAULT_TARGET_POSITIONS !== 'undefined' ? DEFAULT_TARGET_POSITIONS.slice() : [],
    hrActiveFilter: '不限',
    posSearchQuery: '',
    selectedIndustries: [],
    indSearchQuery: '',
    ...
    jobTypes: ['全职'],
    salaryRanges: ['不限'],
    experience: ['应届生(校招)', '经验不限', '1年以内', '1-3年'],
    education: ['本科'],
    companySizes: ['不限'],
    fundingStages: ['不限'],
